...
2. **Authenticate**: If your workspace isn't linked yet, the AI agent will automatically detect it and guide you to provision your credentials directly inside the chat interface.
